...
void draw_scr_today(enum scroll_dir m_scroll_dir)
{
    ...
    */
    ...
    lv_img_set_src(img_steps, &img_steps_48px);
    ...
    lv_img_set_src(img_cals, &img_calories_48px);
    ...
    lv_obj_align_to(img_cals, img_steps, LV_ALIGN_OUT_BOTTOM_MID, 0, 1);
    ...
    lv_obj_set_style_text_color(label_today_cals, lv_palette_lighten(LV_PALETTE_GREEN, 1), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_img_set_src(img_time, &img_clock_48px);
    ...
    lv_obj_align_to(img_time, img_cals, LV_ALIGN_OUT_BOTTOM_MID, 0, 1);
    ...
    lv_obj_set_style_text_color(label_today_active_time, lv_palette_lighten(LV_PALETTE_RED, 1), LV_PART_MAIN | LV_STATE_DEFAULT);
