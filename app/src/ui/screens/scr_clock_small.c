...
void draw_scr_clock_small(enum scroll_dir m_scroll_dir)
{
    ...
    lv_obj_set_style_text_font(ui_label_hour, &lv_font_montserrat_48, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_label_min, &lv_font_montserrat_48, LV_PART_MAIN | LV_STATE_DEFAULT);
