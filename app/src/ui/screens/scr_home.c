...
void draw_scr_home_digital(enum scroll_dir m_scroll_dir)
{
    ...
    ui_label_hour = lv_label_create(scr_home);
    ...
    lv_label_set_text(ui_label_hour, "00 : ");
    ...
    lv_obj_set_style_text_font(ui_label_hour, &ui_font_Number_big, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_label_min = lv_label_create(scr_home);
    //lv_obj_set_width(ui_label_min, LV_SIZE_CONTENT);  /// 1
    //lv_obj_set_height(ui_label_min, LV_SIZE_CONTENT); /// 1
    lv_obj_align_to(ui_label_min, ui_label_hour, LV_ALIGN_TOP_RIGHT, 0, 0);
    lv_label_set_text(ui_label_min, "00");
    ...
    ui_label_date = lv_label_create(scr_home);
