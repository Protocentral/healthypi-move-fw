...
void draw_scr_spo2_select(enum scroll_dir m_scroll_dir, uint32_t arg1, uint32_t arg2, uint32_t arg3, uint32_t arg4)
{
    ...
    lv_obj_t *img_wrist = lv_image_create(btn_spo2_select_wr);
    lv_image_set_src(img_wrist, &img_wrist_45);
    ...
    lv_obj_t *img_finger = lv_image_create(btn_spo2_select_fi);
    lv_image_set_src(img_finger, &img_bpt_finger_45);
