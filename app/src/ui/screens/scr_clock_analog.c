...
void draw_scr_clock_analog(enum scroll_dir m_scroll_dir)
{
    ...
    lv_meter_indicator_t *indic_min = lv_meter_add_needle_line(meter_clock, scale_min, 2, lv_palette_main(LV_PALETTE_RED), -25); //lv_meter_add_needle_img(meter_clock, scale_min, &clock_long_hand, 5, 5);
    lv_meter_indicator_t *indic_hour = lv_meter_add_needle_line(meter_clock, scale_min, 2, lv_palette_main(LV_PALETTE_GREY), -35);//lv_meter_add_needle_img(meter_clock, scale_min, &clock_long_hand, 5, 5);
