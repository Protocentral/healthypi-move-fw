...
/*void draw_scr_spo2(enum scroll_dir m_scroll_dir)
{
    ...
    lv_obj_set_size(scr_spo2, 320, 240);
    ...
    lv_obj_align_to(label_spo2_percent, img1, LV_ALIGN_OUT_BOTTOM_MID, 0, 30);

    // Spo2 Sub bpm label
    lv_obj_t *label_spo2_sub = lv_label_create(scr_spo2);
    lv_label_set_text(label_spo2_sub, " %");
    lv_obj_align_to(label_spo2_sub, label_spo2_percent, LV_ALIGN_OUT_BOTTOM_MID, 0, 0);
