...
lv_obj_t *ui_hr_button_create(lv_obj_t *comp_parent)
{
    ...
    lv_obj_set_width(btn_hr_disp, 120);
    lv_obj_set_height(btn_hr_disp, 120);
    ...
    lv_obj_set_style_bg_opa(btn_hr_disp, 64, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_outline_color(btn_hr_disp, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_hr_number, &lv_font_montserrat_16, LV_PART_MAIN | LV_STATE_DEFAULT);
