 ...
 * Size: 80 px
 * Bpp: 4
 * Opts: --no-compress --font ttf/Inter-SemiBold.ttf --size 80 --bpp 4 --range 0x20,0x30-0x39,0x3A,0x41,0x4D,0x50 --format lvgl --lv-include lvgl.h --lv-font-name inter_semibold_80_time --output lvgl/inter_semibold_80_time.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 844, .box_w = 45, .box_h = 60, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 1350, .adv_w = 541, .box_w = 26, .box_h = 58, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 2104, .adv_w = 798, .box_w = 42, .box_h = 59, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 3343, .adv_w = 814, .box_w = 43, .box_h = 60, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 4633, .adv_w = 853, .box_w = 46, .box_h = 58, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 5967, .adv_w = 805, .box_w = 42, .box_h = 59, .ofs_x = 5, .ofs_y = -1},
    {.bitmap_index = 7206, .adv_w = 819, .box_w = 44, .box_h = 59, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 8504, .adv_w = 738, .box_w = 40, .box_h = 58, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 9664, .adv_w = 819, .box_w = 44, .box_h = 60, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 10984, .adv_w = 819, .box_w = 44, .box_h = 60, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 12304, .adv_w = 408, .box_w = 14, .box_h = 42, .ofs_x = 6, .ofs_y = -1},
    {.bitmap_index = 12598, .adv_w = 931, .box_w = 56, .box_h = 59, .ofs_x = 1, .ofs_y = -1},
    {.bitmap_index = 14250, .adv_w = 1181, .box_w = 63, .box_h = 58, .ofs_x = 5, .ofs_y = 0},
    {.bitmap_index = 16077, .adv_w = 826, .box_w = 44, .box_h = 58, .ofs_x = 5, .ofs_y = 0}
};
