/*
 * Sensor-specific header for MAX32664C driver.
 * Contains driver structs, configs and prototypes that require sensor/i2c/gpio headers.
 */
#ifndef __MAX32664C_SENSOR_H
#define __MAX32664C_SENSOR_H
